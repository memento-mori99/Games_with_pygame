...
# bat init
bat = pygame.image.load(os.path.join(current_path, 'bat.png'))
player_y = 540
...
# ================ ball init ================
ball = pygame.image.load(os.path.join(current_path, 'ball.png'))
...
# =========== brick init ===========
brick = pygame.image.load(os.path.join(current_path, 'brick.png'))
bricks = []
